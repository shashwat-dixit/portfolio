...
The same HTML URLs also return markdown when the client sends `Accept: text/markdown` or a known AI user-agent (`ChatGPT-User`, `GPTBot`, `OAI-SearchBot`, and similar). Normal browsers still get HTML.
